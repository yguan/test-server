...
function onRequest(proxy, req, res, targetServerUrl, cacheManager, isInActiveMode) {
    var isCached = false;
...
//                } else {
//                    proxy.web(req, res, {target: targetServerUrl});
////                        console.log('call proxy for cache not found');
...
function createServer(config) {
    ...
    server = http.createServer(function (req, res) {
        onRequest(proxy, req, res, config.targetServerUrl, cacheManager, isInActiveMode)
    });
